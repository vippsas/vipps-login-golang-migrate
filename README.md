...
--------|------------|--------|------
**master** | :white_check_mark: | `import "github.com/vippsas/vipps-login-golang-migrate/v1"` | New features and bug fixes arrive here first |
**v4** | :white_check_mark: | `import "github.com/vippsas/vipps-login-golang-migrate/v1"` | Used for stable releases |
